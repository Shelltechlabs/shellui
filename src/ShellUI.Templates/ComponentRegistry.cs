...
public static class ComponentRegistry
{
    public static readonly Dictionary<string, ComponentMetadata> Components = new()
    {
        ...
        { "breadcrumb-list", BreadcrumbListTemplate.Metadata },
        { "breadcrumb-link", BreadcrumbLinkTemplate.Metadata },
        { "breadcrumb-page", BreadcrumbPageTemplate.Metadata },
        { "breadcrumb-separator", BreadcrumbSeparatorTemplate.Metadata },
        { "breadcrumb-ellipsis", BreadcrumbEllipsisTemplate.Metadata },
        ...
        { "form-field", FormFieldTemplate.Metadata },
        { "form-item", FormItemTemplate.Metadata },
        { "form-label", FormLabelTemplate.Metadata },
        { "form-control", FormControlTemplate.Metadata },
        { "form-description", FormDescriptionTemplate.Metadata },
        { "form-message", FormMessageTemplate.Metadata },
        ...
        { "menubar-menu", MenubarMenuTemplate.Metadata },
        { "menubar-trigger", MenubarTriggerTemplate.Metadata },
        { "menubar-content", MenubarContentTemplate.Metadata },
        { "menubar-separator", MenubarSeparatorTemplate.Metadata },
        { "pagination", PaginationTemplate.Metadata },
        { "pagination-content", PaginationContentTemplate.Metadata },
        { "pagination-item", PaginationItemTemplate.Metadata },
        { "pagination-link", PaginationLinkTemplate.Metadata },
        { "pagination-previous", PaginationPreviousTemplate.Metadata },
        { "pagination-next", PaginationNextTemplate.Metadata },
        { "pagination-ellipsis", PaginationEllipsisTemplate.Metadata },
        ...
        { "sheet-header", SheetHeaderTemplate.Metadata },
        { "sheet-title", SheetTitleTemplate.Metadata },
        { "sheet-description", SheetDescriptionTemplate.Metadata },
        { "sheet-footer", SheetFooterTemplate.Metadata },
        { "sheet-close", SheetCloseTemplate.Metadata },
        ...
        { "drawer-header", DrawerHeaderTemplate.Metadata },
        { "drawer-footer", DrawerFooterTemplate.Metadata },
        { "drawer-title", DrawerTitleTemplate.Metadata },
        { "drawer-description", DrawerDescriptionTemplate.Metadata },
        { "drawer-close", DrawerCloseTemplate.Metadata },
        ...
        { "alert-dialog-trigger", AlertDialogTriggerTemplate.Metadata },
        { "alert-dialog-content", AlertDialogContentTemplate.Metadata },
        { "alert-dialog-header", AlertDialogHeaderTemplate.Metadata },
        { "alert-dialog-title", AlertDialogTitleTemplate.Metadata },
        { "alert-dialog-description", AlertDialogDescriptionTemplate.Metadata },
        { "alert-dialog-footer", AlertDialogFooterTemplate.Metadata },
        { "alert-dialog-action", AlertDialogActionTemplate.Metadata },
        { "alert-dialog-cancel", AlertDialogCancelTemplate.Metadata },
        ...
        { "command-models", CommandModelsTemplate.Metadata },
        { "command-palette", CommandPaletteTemplate.Metadata },
        { "command-input", CommandInputTemplate.Metadata },
        { "command-list", CommandListTemplate.Metadata },
        { "command-group", CommandGroupTemplate.Metadata },
        { "command-item", CommandItemTemplate.Metadata },
        { "command-empty", CommandEmptyTemplate.Metadata },
        { "command-separator", CommandSeparatorTemplate.Metadata },
    ...
    public static string? GetComponentContent(string componentName)
    {
        return componentName.ToLower() switch
        {
            ...
            "breadcrumb-list" => BreadcrumbListTemplate.Content,
            "breadcrumb-link" => BreadcrumbLinkTemplate.Content,
            "breadcrumb-page" => BreadcrumbPageTemplate.Content,
            "breadcrumb-separator" => BreadcrumbSeparatorTemplate.Content,
            "breadcrumb-ellipsis" => BreadcrumbEllipsisTemplate.Content,
            ...
            "form-field" => FormFieldTemplate.Content,
            "form-item" => FormItemTemplate.Content,
            "form-label" => FormLabelTemplate.Content,
            "form-control" => FormControlTemplate.Content,
            "form-description" => FormDescriptionTemplate.Content,
            "form-message" => FormMessageTemplate.Content,
            ...
            "menubar-menu" => MenubarMenuTemplate.Content,
            "menubar-trigger" => MenubarTriggerTemplate.Content,
            "menubar-content" => MenubarContentTemplate.Content,
            "menubar-separator" => MenubarSeparatorTemplate.Content,
            "pagination" => PaginationTemplate.Content,
            "pagination-content" => PaginationContentTemplate.Content,
            "pagination-item" => PaginationItemTemplate.Content,
            "pagination-link" => PaginationLinkTemplate.Content,
            "pagination-previous" => PaginationPreviousTemplate.Content,
            "pagination-next" => PaginationNextTemplate.Content,
            "pagination-ellipsis" => PaginationEllipsisTemplate.Content,
            ...
            "sheet-header" => SheetHeaderTemplate.Content,
            "sheet-title" => SheetTitleTemplate.Content,
            "sheet-description" => SheetDescriptionTemplate.Content,
            "sheet-footer" => SheetFooterTemplate.Content,
            "sheet-close" => SheetCloseTemplate.Content,
            ...
            "drawer-header" => DrawerHeaderTemplate.Content,
            "drawer-footer" => DrawerFooterTemplate.Content,
            "drawer-title" => DrawerTitleTemplate.Content,
            "drawer-description" => DrawerDescriptionTemplate.Content,
            "drawer-close" => DrawerCloseTemplate.Content,
            ...
            "alert-dialog-trigger" => AlertDialogTriggerTemplate.Content,
            "alert-dialog-content" => AlertDialogContentTemplate.Content,
            "alert-dialog-header" => AlertDialogHeaderTemplate.Content,
            "alert-dialog-title" => AlertDialogTitleTemplate.Content,
            "alert-dialog-description" => AlertDialogDescriptionTemplate.Content,
            "alert-dialog-footer" => AlertDialogFooterTemplate.Content,
            "alert-dialog-action" => AlertDialogActionTemplate.Content,
            "alert-dialog-cancel" => AlertDialogCancelTemplate.Content,
            ...
            "command-models" => CommandModelsTemplate.Content,
            "command-palette" => CommandPaletteTemplate.Content,
            "command-input" => CommandInputTemplate.Content,
            "command-list" => CommandListTemplate.Content,
            "command-group" => CommandGroupTemplate.Content,
            "command-item" => CommandItemTemplate.Content,
            "command-empty" => CommandEmptyTemplate.Content,
            "command-separator" => CommandSeparatorTemplate.Content,
